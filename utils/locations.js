...
export const UPAZILLAS = [
  ...
  {id: 100, district_id: 45, name: "Cox's Bazar Sadar"},
  ...
  {id: 493, district_id: 16, name: "Shibbari"},
  {id: 494, district_id: 2, name: "Kotwali"},
  {id: 495, district_id: 21, name: "Singra"},
  {id: 496, district_id: 29, name: "Lalmonirhat"},
  {id: 497, district_id: 53, name: "Dakshin Sunamganj"},
  {id: 498, district_id: 28, name: "Rajibpur"},
  {id: 499, district_id: 49, name: "Charjabbar"},
  {id: 500, district_id: 1, name: "Gandaria"},
  {id: 501, district_id: 39, name: "Swarupkati"},
  {id: 502, district_id: 13, name: "Netrokona Sadar"},
  {id: 503, district_id: 1, name: "Uttarkhan"},
  {id: 504, district_id: 1, name: "Ashulia"},
  {id: 505, district_id: 59, name: "Khalishpur"},
  {id: 506, district_id: 24, name: "Boalia"},
  {id: 507, district_id: 24, name: "Rajshahi Sadar"},
  {id: 508, district_id: 28, name: "Kachakata"},
  {id: 509, district_id: 43, name: "Panchlaish"},
  {id: 510, district_id: 1, name: "Badda"},
  {id: 511, district_id: 43, name: "Chawkbazar"},
  {id: 512, district_id: 63, name: "Naragati"},
  {id: 513, district_id: 19, name: "Joypurhat"},
  {id: 514, district_id: 62, name: "Meherpur Sadar"},
  {id: 515, district_id: 57, name: "Kotwali"},
  {id: 516, district_id: 1, name: "Sabujbagh"},
  {id: 517, district_id: 10, name: "Tarakanda"},
  {id: 518, district_id: 62, name: "Gangni"},
  {id: 519, district_id: 53, name: "Moddhonagar"},
  {id: 520, district_id: 1, name: "Sutrapur"},
  {id: 521, district_id: 59, name: "Daulatpur"},
  {id: 522, district_id: 3, name: "Gazipur Sadar"},
  {id: 523, district_id: 24, name: "Rajpara"},
  {id: 524, district_id: 54, name: "South Surma"},
  {id: 525, district_id: 1, name: "vatara"},
  {id: 526, district_id: 21, name: "Naldanga"},
  {id: 527, district_id: 39, name: "Indurkani"},
  {id: 528, district_id: 54, name: "Lamabazar"},
  {id: 529, district_id: 15, name: "Shariatpur Sadar"},
  {id: 530, district_id: 32, name: "Kotwali"},
  {id: 531, district_id: 50, name: "Rangamati Hill Tracks"},
  {id: 532, district_id: 33, name: "Ruhea"},
  {id: 533, district_id: 1, name: "Hajaribagh"},
  {id: 534, district_id: 14, name: "Goalanda"},
  {id: 535, district_id: 59, name: "Sonadanga"},
  {id: 536, district_id: 15, name: "Palong"},
  {id: 537, district_id: 1, name: "Mirpur"},
  {id: 538, district_id: 50, name: "Kotwali"},
  {id: 539, district_id: 23, name: "Bhabanipur"},
  {id: 540, district_id: 54, name: "Kotwali"},
  {id: 541, district_id: 3, name: "Joydebpur"},
  {id: 542, district_id: 1, name: "Demra"},
  {id: 543, district_id: 22, name: "Chapai Nawabganj Sadar"},
  {id: 544, district_id: 43, name: "EPZ"},
  {id: 545, district_id: 35, name: "Barishal Sadar"},
  {id: 546, district_id: 54, name: "Shahporan"},
  {id: 547, district_id: 59, name: "Khulna Sadar"},
  {id: 548, district_id: 43, name: "Bayzid"},
  {id: 549, district_id: 18, name: "Bogura Sadar"},
  {id: 550, district_id: 35, name: "Kotoali"},
  {id: 551, district_id: 44, name: "Kotwali"},
  {id: 552, district_id: 48, name: "Chandragonj"},
  {id: 553, district_id: 44, name: "Adarsha Sadar"},
  {id: 554, district_id: 3, name: "Sreepur"},
  {id: 555, district_id: 23, name: "Ataykula"},
  {id: 556, district_id: 1, name: "Lalbag"},
  {id: 557, district_id: 54, name: "Osmani Nagar"},
  {id: 558, district_id: 56, name: "Chuadanga Sadar"},
  {id: 559, district_id: 54, name: "Jalalabad"},
  {id: 560, district_id: 26, name: "Kotoali"},
  {id: 561, district_id: 46, name: "Kotatoli"},
  {id: 562, district_id: 43, name: "Sadarghat"},
  {id: 563, district_id: 54, name: "Airport"},
  {id: 564, district_id: 18, name: "Kazipara"},
  {id: 565, district_id: 44, name: "Bangora Bazar"},
  {id: 566, district_id: 63, name: "Narail Sadar"},
  {id: 567, district_id: 1, name: "Pallabi"},
  {id: 568, district_id: 35, name: "Rupatali"},
  {id: 569, district_id: 35, name: "Rupatali"},
  {id: 570, district_id: 35, name: "Kiwnia"},
  {id: 571, district_id: 11, name: "Fotullah"},
  {id: 572, district_id: 18, name: "Shahjadpur"},
  {id: 573, district_id: 15, name: "Janzira"},
  {id: 574, district_id: 32, name: "Haragach"},
  {id: 575, district_id: 32, name: "Ulipur"},
  {id: 576, district_id: 43, name: "Chandgonj"},
  {id: 577, district_id: 23, name: "Hemayetpur"},
  {id: 578, district_id: 49, name: "Sudharam"},
  {id: 579, district_id: 43, name: "Chandgong"},
  {id: 580, district_id: 3, name: "Gacha"},
  {id: 581, district_id: 54, name: "Moglabazar"},
  {id: 582, district_id: 21, name: "Gurudaspur"},
  {id: 583, district_id: 23, name: "Aminpur"},
  {id: 584, district_id: 43, name: "Jorar Gonj"},
  {id: 585, district_id: 54, name: "Kushighat"},
  {id: 586, district_id: 1, name: "Kadamtoli"},
  {id: 587, district_id: 1, name: "Dhanmondi"},
  {id: 588, district_id: 43, name: "Haildhar"},
  {id: 589, district_id: 24, name: "Katakhali"},
  {id: 590, district_id: 57, name: "Chowgacha"},
  {id: 591, district_id: 32, name: "Tajhat"},
  {id: 592, district_id: 1, name: "Dakshinkhan"},
  {id: 593, district_id: 49, name: "Maizdee"},
  {id: 594, district_id: 24, name: "Chondrima"},
  {id: 595, district_id: 24, name: "Pochamaria"},
  {id: 596, district_id: 24, name: "Shamukhdum"},
  {id: 597, district_id: 1, name: "Uttara"},
  {id: 598, district_id: 17, name: "South Chamuria"},
  {id: 599, district_id: 53, name: "South Sunamganj"},
  {id: 600, district_id: 25, name: "Enayatpur"},
  {id: 601, district_id: 19, name: "Joypurhat Sadar"},
  {id: 602, district_id: 48, name: "Hiramonbazar"},
  {id: 603, district_id: 43, name: "Shiberhat"},
  {id: 604, district_id: 23, name: "Sathiya"},
  {id: 605, district_id: 44, name: "Lalmai"},
  {id: 606, district_id: 1, name: "Tejgaon 1\/A"},
  {id: 607, district_id: 1, name: "Tejgaon"},
  {id: 608, district_id: 44, name: "Bangora"},
  {id: 609, district_id: 24, name: "Karnoher"},
  {id: 610, district_id: 35, name: "Airport"}
];
